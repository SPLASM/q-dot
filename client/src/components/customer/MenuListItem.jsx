      ...
      <li>
        ...
        { this.state.rewardTriggered ?
          <div className="d-inline">
            <button onClick={() => {
              this.props.removeOrder(this.props.menuItem, this.props.index);
              this.handleRewardClick(0);
            }} className="getMenuBtn pull-right">Remove from Order</button>
          ...
          <div>
            { this.props.reward ?
              <div className="d-inline">
                ...
                <button onClick={() => this.handleRewardClick(10)} className={this.state.rewardTriggered ? '  btn-large disabled pull-right' : 'getMenuBtn getRewardBtn pull-right'}>Claim Reward</button>
              </div>
              : this.props.remove ?
